...
namespace DataStructureAlgorithms
{
    internal class CustomDataBaase
    {
        ...
        public void PopulateWithSampleStudent()
        {
            ...
            Student student1 = new Student("Ahmed", "Elsaka", "6752", score1);
            float[] score2 = { 10, 20, 30, 40 };
            Student student2 = new Student("Dario", "Lulashi", "4325", score2);
            float[] score3 = { 70, 80, 90, 100 };
            Student student3 = new Student("Murat", "Dedolli"; "5473", score3);
